...
const Footer = () => {
  ...
  const quickLinks = [
    ...
    { href: "#investor", text: "Investor Desk" },
    { href: "#news", text: "News" },
  ...
  const contactInfo = [
    { 
      ...
      content: <>
        Survey No. 46, Plot No. 5,<br />
        Pen Khopoli Road, Village Arav,<br />
        P.O. Ransai, Pen,<br />
        Dist. Raigad, 402 107.
      </> 
    },
    { 
      ...
      content: <a href="tel:+14155550123" className="text-gray-600 hover:text-blue-700">(415) 555-0123</a> 
    },
    { 
      icon: <Mail className="h-4 w-4" />, 
      content: <a href="mailto:info@INFRA.com" className="text-gray-600 hover:text-blue-700">info@INFRA.com</a> 
    },
    { 
  ...
  return (
    <footer className="bg-gradient-to-br from-sky-50 via-white to-blue-50 relative overflow-hidden" id="contact">
      {/* Decorative Elements */}
      <div className="absolute top-0 left-0 w-full h-full">
        ...
        <div className="absolute w-full h-full overflow-hidden opacity-20">
          {[...Array(4)].map((_, i) => (
            <div key={i} className="absolute w-2 h-2 rounded-full bg-blue-500 animate-float"
              style={{
                top: `${Math.random() * 100}%`,
          ...
          <div>
            ...
            <div className="flex space-x-3">
              {socialIcons.map((icon, i) => (
                <a key={i} href="#" className="bg-blue-100 hover:bg-blue-200 p-2 rounded-full text-blue-700 hover:text-blue-800 transition shadow-sm" aria-label={icon.name}>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {quickLinks.map((link, i) => (
                <li key={i}>
                  <a href={link.href} className="text-gray-600 hover:text-blue-700 flex items-center group">
      ...
      <div className="py-6 relative z-10">
        <div className="container">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-600 text-sm">© {currentYear} INFRA. All Rights Reserved.</p>
            ...
            <div className="flex space-x-6 mt-4 md:mt-0">
              {["Privacy Policy", "Terms of Service"].map((item, i) => (
                <a key={i} href="#" className="text-gray-600 hover:text-blue-700 text-sm flex items-center">
