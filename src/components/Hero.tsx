...
const Hero = () => {
  const carouselImages = [
    { src: "/img/slide-1.png", alt: "Industrial water tank installation" },
    { src: "/img/slide-2.png", alt: "Commercial water storage solutions" },
    { src: "/img/slide-3.png", alt: "Residential water tanks" }
  ];
  ...
  useEffect(() => {
    if (emblaApi) {
      const intervalId = setInterval(() => emblaApi.scrollNext(), 4000);
  ...
  const features = [
    { icon: Shield, title: "10-Year Warranty", subtitle: "Guaranteed durability" },
    { icon: Award, title: "ISO Certified", subtitle: "Quality guaranteed" }
  ];

  const badges = [
    { position: "-right-4 md:right-4 top-8", text: "UV Resistant" },
    { position: "-left-4 md:left-4 bottom-24", text: "BPA-Free Material" }
  ];
    ...
    <section className="pt-28 pb-16 md:pt-24 md:pb-20 bg-gradient-to-br from-sky-50 via-white to-blue-50 relative overflow-hidden">
      ...
      <div className="container flex flex-col-reverse md:flex-row items-center relative z-10">
        ...
        <div className="md:w-1/2 mt-8 md:mt-0 md:pr-8">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-blue-900 leading-tight mb-2">Water and Industrial</h1>
          <h2 className="text-3xl md:text-4xl font-bold text-blue-700 leading-tight">Storage Solutions</h2>
          ...
          <div className="grid grid-cols-2 gap-4 mt-10 pt-6 border-t border-blue-100">
            {features.map((feature, idx) => (
              <div key={idx} className="flex items-center">
                ...
                <div>
                  <p className="font-semibold text-blue-900">{feature.title}</p>
          ...
          <div className="relative">
            ...
            <div className="relative z-10">
                ...
                <div className="flex">
                  {carouselImages.map((image, index) => (
                    <div key={index} className="flex-[0_0_100%] min-w-0">
                      <div className="relative w-full h-72 md:h-96 bg-blue-100 rounded-xl overflow-hidden">
              ...
              {badges.map((badge, idx) => (
                <div key={idx} className={`absolute ${badge.position} bg-white p-3 rounded-lg shadow-lg z-20`}>
                  <div className="flex items-center">
                    <div className="bg-blue-100 p-2 rounded-full mr-2">
                      <Check className="h-4 w-4 text-blue-700" />
                    </div>
                    <span className="text-sm font-medium text-blue-900">{badge.text}</span>
                  </div>
                </div>
              ))}
            </div>
